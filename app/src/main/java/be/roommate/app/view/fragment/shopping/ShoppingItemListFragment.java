package be.roommate.app.view.fragment.shopping;
...
import be.roommate.app.model.dto.list.ListShoppingItemDTO;
...
import be.roommate.app.view.listAdapter.ShoppingItemListAdapter;
...
public class ShoppingItemListFragment extends Fragment {
    ...
    private class RemoveRequest extends AsyncTask<String, Void, Void> {
        ...
        protected Void doInBackground(String... params) {
            ...
            WebClient<ResultDTO> webClient = new WebClient<>(RequestEnum.SHOPPING_ITEM_REMOVE, ResultDTO.class);
            webClient.setParams("shoppingItemId",shoppingItemDTO.getId()+"");
            try {
    ...
    private class RefreshRequest extends AsyncTask<String, Void, Void> {
        ...
        protected Void doInBackground(String... params) {
            ...
            try {
                listShoppingItemDTO = webClient.sendRequest(ShoppingItemListFragment.this.getActivity());
