...
import be.roommate.app.view.dialog.CalculatorEventInterface;
import be.roommate.app.view.dialog.DialogConstructor;
import be.roommate.app.view.spinner.SelectionWithOpenFieldSpinner;
...
public class EditTicketActivity extends AbstractEditActivity<TicketDTO> {
    ...
    protected WebClient<TicketDTO> getWebClient() {
        ...
        if (ticket.getId() == null) {
            ...
            webClient = new WebClient<>(RequestEnum.TICKET_EDIT,
                    ticket,
                    TicketDTO.class);
            webClient.setParams("ticketId",ticket.getId()+"");
        }
        return webClient;
    }
    ...
    protected void save() {
        ...
        if (!ignoreTicket) {
            ...
            if (descriptionField.control() && dateField.control()) {
                ...
                //send request
                Request request = new Request(this,this, getWebClient());
    ...
    private void sendBoughtShoppingItem(){
        ...
        if (shoppingItemList != null) {
            ...
            Request requestForBought = new Request(this,this, getWebClientForShoppingItemBought(listShoppingItemBoughtIds));
    ...
    protected WebClient<ResultDTO> getWebClientForShoppingItemBought(String listShoppingItemBoughtIds) {
        ...
        webClient = new WebClient<>(RequestEnum.SHOPPING_ITEM_BOUGHT,
                null,
                ResultDTO.class);
        webClient.setParams("shoppingItemId",listShoppingItemBoughtIds+"");
        return webClient;
    }
