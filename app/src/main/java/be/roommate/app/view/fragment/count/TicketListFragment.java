...
import be.roommate.app.view.listAdapter.TicketListAdapter;
...
public class TicketListFragment extends Fragment {
    ...
    private class RemoveRequest extends AsyncTask<String, Void, Void> {
        ...
        protected Void doInBackground(String... params) {
            ...
            WebClient<ResultDTO> webClient = new WebClient<>(RequestEnum.TICKET_REMOVE, ResultDTO.class);
            webClient.setParams("ticketId",ticketDTO.getId()+"");
            try {
